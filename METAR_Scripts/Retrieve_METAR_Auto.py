...
def main(PATH, year, month, day):
    """Our main method"""
    # timestamps in UTC to request data for
    startts = datetime.datetime(year, month, day, 00)
    endts = datetime.datetime(year, month, day + 1, 00)
...
#    stations = get_stations_from_networks()
    ...
    BASEDIR = '/home/alton/WRF_OUT/Sat_Reprojection/Data/METAR_CLDBASE_HGHT/'
    
    today = date.today()
    d = today.strftime("%Y""%m""%d")
    
    DATA_PATH = BASEDIR + str(d) + '/'
