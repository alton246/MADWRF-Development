...
TS_DIR = BASE_DIR + '18Z/Ts_List_Ang0_034/'
ts_file = 'Bco.d04.TS'
...
mask1 = pd.date_range("2020-06-22 18:00:00", freq="15T", periods=49)
mask = ds.sel(time=slice('2020-06-22 18:00:00', '2020-06-23 06:00:00'))
